...
class Cache
{
    ...
    public function get($id, $group = 'cache', $maxsecs = 295)
    {
        if (! $this->enabled) {
            return false;
        }
    ...
    public function get_arr($id, $group = 'cache', $maxsecs = 295)
    {
        if (! $this->enabled) {
            return false;
        }
    ...
    public function set($id, $group, $value)
    {
        if (! $this->enabled) {
            return false;
        }
    ...
    public function set_arr($id, $group, $array)
    {
        if (! $this->enabled) {
            return false;
        }
